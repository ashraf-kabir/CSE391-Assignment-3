...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['post'])) {
        ...
        $sql ="INSERT INTO `jobs`(`title`,`description`,`link`,`is_active`) VALUES(:title,:description,:status)";
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add New Jobs</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Add Jobs</b></h4>
                                    <hr/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input id="input" type="text" class="form-control" name="title"
                                                               placeholder="Enter a title" maxlength="50"
                                                               required>
                                                    </div>
                                                </div>
