    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="index.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i>
                        <span>Read from file</span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li><a href="read-csv.php">Read CSV</a></li>
                    </ul>
                </li>
        ...
        <div class="help-box">
            ...
            <p class=""><span class="text-custom">Email:</span> <br/> admin@gmail.com</p>
        </div>
