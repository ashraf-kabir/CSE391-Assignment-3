...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql ="INSERT INTO `groups`(`name`,`description`,`is_active`) VALUES(:name,:description,:status)";
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Add Groups</b></h4>
                                    <hr/>
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-horizontal" name="user" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="input" class="col-md-2 control-label">Group Name</label>
                                                    <div class="col-md-10">
                                                        <input id="input" type="text" class="form-control" name="name"
                                                               placeholder="Enter Group Name" maxlength="25"
                                                               required>
                                                    </div>
                                                </div>
