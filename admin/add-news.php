...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['post'])) {
        ...
        $sql ="INSERT INTO `news`(`headline`,`description`,`is_active`) VALUES(:headline,:description,:status)";
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-horizontal" name="user" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="input" class="col-md-2 control-label">Headline</label>
                                                    <div class="col-md-10">
                                                        <input id="input" type="text" class="form-control" name="headline"
                                                               placeholder="Enter headline" maxlength="25"
                                                               required>
                                                    </div>
                                                </div>
