...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE `slots` SET name=:name,description=:description WHERE id=:id ";
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edit Slots</b></h4>
                                    <hr/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <?php
                                            $id = intval($_GET['id']);
                                            $sql = "SELECT slots.* FROM slots WHERE slots.id=:id";
                                            $query = $dbh->prepare($sql);
                                            $query->bindParam(':id', $id, PDO::PARAM_STR);
                                            $query->execute();
