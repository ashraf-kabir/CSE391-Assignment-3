...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE `jobs` SET title=:title,description=:description,link=:link WHERE id=:id ";
        ...
        echo "<script>alert('Job has updated successfully');</script>";
    }
    ?>
    <!DOCTYPE html>
    <html lang="en">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Edit Jobs</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edit Jobs</b></h4>
                                    <hr/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <?php
                                            $id = intval($_GET['id']);
                                            $sql = "SELECT jobs.* FROM `jobs` WHERE jobs.id=:id";
                                            $query = $dbh->prepare($sql);
                                            $query->bindParam(':id', $id, PDO::PARAM_STR);
                                            $query->execute();
                                            ...
                                            <form class="form-horizontal" name="user" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input id="title" type="text" class="form-control"
                                                               ...
                                                               name="title" maxlength="60" required>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label"
                                                           for="link">Link</label>
                                                    <div class="col-md-10">
                                                        <textarea id="link" class="form-control" rows="5"
                                                                  maxlength="255" name="link"
                                                                  required><?php echo htmlentities($result->link); ?></textarea>
                                                        <div id="link_feedback"></div>
                                                    </div>
                                                </div>
